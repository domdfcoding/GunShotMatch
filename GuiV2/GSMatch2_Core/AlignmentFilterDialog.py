...
class AlignmentFilterDialog(wx.Dialog):
	def __init__(self, parent, *args, **kwds):
		...
		self.min_samples_value = wx.SpinCtrl(self.main_panel, wx.ID_ANY, "0", min=0, max=100)
	...
	def __set_properties(self):
		...
		self.SetSize((450, 200))
		self.min_samples_value.SetToolTip(wx.ToolTip("The minimum number of Experiments the peak must be present in"))
		self.min_rt_value.SetMinSize((-1, 29))
		self.min_rt_value.SetToolTip(wx.ToolTip("Show only peaks after this time"))
		self.min_rt_value.SetDigits(2)
		self.max_rt_value.SetMinSize((-1, 29))
		self.max_rt_value.SetToolTip(wx.ToolTip("Show only peaks before this time"))
	...
	def __do_layout(self):
		...
		min_samples_label = wx.StaticText(self.main_panel, wx.ID_ANY, "Minimum Experiments: ")
		min_samples_label.SetToolTip(wx.ToolTip("The minimum number of Experiments the peak must be present in"))
		main_sizer.Add(min_samples_label, 0, wx.ALIGN_CENTER_VERTICAL, 0)
		main_sizer.Add(self.min_samples_value, 0, wx.ALIGN_CENTER_VERTICAL, 0)
		min_rt_label = wx.StaticText(self.main_panel, wx.ID_ANY, "Minimum Retention Time: ")
		min_rt_label.SetToolTip(wx.ToolTip("Show only peaks after this time"))
		...
		max_rt_label.SetToolTip(wx.ToolTip("Show only peaks before this time"))
	...
	def load_settings(self):
		...
		self.min_samples_value.SetValue(self.parent.filter_min_experiments)
		
		self.min_samples_value.SetMax(self.parent.n_experiments)
	...
	def apply_settings(self):
		...
		self.parent.filter_min_experiments = self.min_samples_value.GetValue()
